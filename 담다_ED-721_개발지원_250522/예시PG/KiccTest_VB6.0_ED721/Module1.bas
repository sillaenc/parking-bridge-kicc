...
Public Declare Function KSetOPKeyN Lib "KiccPos.DLL" (ByVal SheftOkkey As Long, ByVal Okkey As Long, ByVal SheftCancelKey As Long, ByVal CancelKey As Long, ByVal SheftSignKey As Long, ByVal SignKey As Long) As Long
...
Public Declare Function KDecodingCardHash Lib "KiccPos.DLL" (ByVal sRndKey As String, ByVal sEncCardHash As String, ByVal sDecCardHash As String, ByVal ErrMsg As String) As Long
Public Declare Function KReqEncKeyInData Lib "KiccPos.DLL" (ByVal sRndKey As String, ByVal sKeyInData As String, ByVal ErrMsg As String) As Long
...
Public Declare Sub KResetMem Lib "KiccPos.DLL" ()

Public Declare Function KGetMemberShip Lib "KiccPos.DLL" (ByVal Value As String) As Long
Public Declare Function KGetMemberShipHex Lib "KiccPos.DLL" (ByVal Value As String) As Long

Public Declare Function KReqHTTP Lib "KiccPos.DLL" (ByVal URL As String, ByVal ReqData As String, ByVal RecvData As String, ByVal CommType As String, ByVal MsgType As String, ByVal Err As String) As Long
